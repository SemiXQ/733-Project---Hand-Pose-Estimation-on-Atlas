...
COLORMAP = {
    "thumb": {"ids": [0, 1, 2, 3, 4], "color": (0, 128, 0)},
    "index": {"ids": [0, 5, 6, 7, 8], "color": (255, 255, 0)},
    "middle": {"ids": [0, 9, 10, 11, 12], "color": (0, 0, 255)},
    "ring": {"ids": [0, 13, 14, 15, 16], "color": (199, 21, 133)},
    "little": {"ids": [0, 17, 18, 19, 20], "color": (255, 0, 0)},
}
